...
public class EmployeesController {
    ...
    public EmployeeResponseDTO findEmployeeByUserName(@PathVariable String username) throws NotFoundException {
        // mandar a crear el employee al port
        Employee result = employeesPort.findEmployeeByUsername(username);
        return employeeMapper.fromEmployeeToResponse(result);
    }
